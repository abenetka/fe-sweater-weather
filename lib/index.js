...
$(document).ready(function(){
  ...
  function postFavorites() {
    let favLocation = $('#cityState').val();
    $.post(`https://sweather-weather.herokuapp.com/api/v1/favorites?location=${favLocation}&api_key=71caee34584ad1b2fcc7`, function(data, status) {
    });
  }

  // function getFavorites(cityState) {
  //   $.get(`https://sweather-weather.herokuapp.com/api/v1/favorites?location=${cityState}&api_key=71caee34584ad1b2fcc7`, function(data, status) {
  //     let dailyForecastData = data["data"]["attributes"]["daily_weather"];
  //   });
  // }
