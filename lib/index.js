...
$(document).ready(function(){
  ...
  function getExtendedForecast(cityState) {
    $.get(`https://sweather-weather.herokuapp.com/api/v1/forecast?location=${cityState}`, function(data, status) {
      ...
      $(".tempHigh1").text("High: " + `${dailyForecastData[0]["temperatureHigh"]}` + "°")
      $(".tempHigh2").text("High: " + `${dailyForecastData[1]["temperatureHigh"]}` + "°")
      $(".tempHigh3").text("High: " + `${dailyForecastData[2]["temperatureHigh"]}` + "°")
      $(".tempHigh4").text("High: " + `${dailyForecastData[3]["temperatureHigh"]}` + "°")
      $(".tempHigh5").text("High: " + `${dailyForecastData[4]["temperatureHigh"]}` + "°")
      $(".tempHigh6").text("High: " + `${dailyForecastData[5]["temperatureHigh"]}` + "°")
      $(".tempHigh7").text("High: " + `${dailyForecastData[6]["temperatureHigh"]}` + "°")
      $(".tempLow1").text("Low: " + `${dailyForecastData[0]["temperatureLow"]}` + "°")
      $(".tempLow2").text("Low: " + `${dailyForecastData[1]["temperatureLow"]}` + "°")
      $(".tempLow3").text("Low: " + `${dailyForecastData[2]["temperatureLow"]}` + "°")
      $(".tempLow4").text("Low: " + `${dailyForecastData[3]["temperatureLow"]}` + "°")
      $(".tempLow5").text("Low: " + `${dailyForecastData[4]["temperatureLow"]}` + "°")
      $(".tempLow6").text("Low: " + `${dailyForecastData[5]["temperatureLow"]}` + "°")
      $(".tempLow7").text("Low: " + `${dailyForecastData[6]["temperatureLow"]}` + "°")
