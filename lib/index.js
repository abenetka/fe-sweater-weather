...
$(document).ready(function(){
  ...
  function postFavorites() {
    let newFavLocation = $('#cityState').val();
    $.post(`https://sweather-weather.herokuapp.com/api/v1/favorites?location=${newFavLocation}&api_key=71caee34584ad1b2fcc7`, function(data, status) {
    });
  }
